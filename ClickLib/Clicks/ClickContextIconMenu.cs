...
namespace ClickLib.Clicks
{
    ...
    public sealed unsafe class ClickContextIconMenu : ClickAddonBase<AddonContextIconMenu>
    {
        ...
        public void SelectItem(ushort index)
        {
            ...
            inputData.Data[0] = (void*)this.Addon->AtkComponentList240->ItemRendererList[index].AtkComponentListItemRenderer;
            inputData.Data[2] = (void*)(index | ((ulong)index << 48));

            ClickAddonComponent(&this.Addon->AtkUnitBase, this.Addon->AtkComponentList240->AtkComponentBase.OwnerNode, 0, EventType.LIST_INDEX_CHANGE, null, inputData);
        }
